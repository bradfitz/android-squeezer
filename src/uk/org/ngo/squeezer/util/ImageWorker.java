...
public abstract class ImageWorker {
     ...
     * <p>
     * Modeled on {@link AsyncTask.THREAD_POOL_EXECUTOR}, this differs by
     * setting a lower number of executing tasks, while increasing the number of
     * tasks that can be queued.
     * <p>
     * In addition, an explicit {@link ThreadPoolExecutor.DiscardOldestPolicy}
     * is used, should the number of queued tasks grow too high (the default
     * policy triggers a RejectedExecutionException if too many tasks are
     * queued).
     */
    public static final Executor THREAD_POOL_EXECUTOR = new ThreadPoolExecutor(CORE_POOL_SIZE,
            MAXIMUM_POOL_SIZE, KEEP_ALIVE,
            TimeUnit.SECONDS, sPoolWorkQueue, sThreadFactory, new DiscardOldestPolicy());
