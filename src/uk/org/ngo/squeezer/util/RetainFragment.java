 ...
 * <p>
 * Get an instance of this class by calling {@link #getInstance(String, FragmentManager)}, and
 * place objects that should be persisted across the activity lifecycle using
 * {@link #put(String, Object)}. Retrieve persisted objects with {@link #get(String)}.
 */
public class RetainFragment extends Fragment {
    private static final String TAG = RetainFragment.class.getName();

    private Map<String, Object> mHash = new Hashtable<String, Object>();
