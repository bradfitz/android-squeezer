...
public class MenuFragment extends Fragment {
    ...
    */
    ...
    /**
    * Conditionally add a fragment of the given type to the supplied activity.
    * If a fragment of the given type has not previously been added to the activity
    * (by this method), then a new instance of the fragment is created, and added
    * to the activity by calling {@link FragmentTransaction#add(Fragment, String)}
    *
    ...
    public static void add(FragmentActivity activity, Class<? extends Fragment> clazz) {
        ...
        if (fragmentManager.findFragmentByTag(clazz.getName()) == null) {
            ...
            try {
                ...
                throw new InstantiationException("Unable to instantiate fragment " + clazz.getName(), e);
            }
