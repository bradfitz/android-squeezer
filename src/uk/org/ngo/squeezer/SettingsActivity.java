...
public class SettingsActivity extends PreferenceActivity implements
	...
	private void fillPlayableItemSelectionPreferences() {
		...
		onSelectAlbumPref.setDefaultValue(PlayableItemAction.Type.PLAY.name());
		if (onSelectAlbumPref.getValue() == null) {
			onSelectAlbumPref.setValue(PlayableItemAction.Type.PLAY.name());
		}
		...
		onSelectSongPref.setEntries(new String[] { playLabel, insertLabel,
				addLabel });
		onSelectSongPref.setDefaultValue(PlayableItemAction.Type.PLAY.name());
		if (onSelectSongPref.getValue() == null) {
			onSelectSongPref.setValue(PlayableItemAction.Type.PLAY.name());
		}
	}
    @Override
