...
public class AlbumViewDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(activity.getServerString(SqueezerServerString.ALBUM_DISPLAY_OPTIONS));
        builder.setAdapter(new BaseAdapter() {
                ...
                public View getView(int position, View convertView, ViewGroup parent) {
                    if (position < POSITION_SORT_LABEL) {
                        CheckedTextView textView = (CheckedTextView) activity.getLayoutInflater().inflate(android.R.layout.select_dialog_singlechoice, parent, false);
                    ...
                    textView.setText(getString(R.string.choose_sort_order, activity.getItemAdapter().getQuantityString(2)));
                    return textView;
                }
    ...
    public enum AlbumListLayout {
        grid(R.drawable.ic_action_view_as_grid, SqueezerServerString.SWITCH_TO_GALLERY),
        list(R.drawable.ic_action_view_as_list, SqueezerServerString.SWITCH_TO_EXTENDED_LIST);
        ...
        private AlbumListLayout(int icon, SqueezerServerString serverString) {
