 ...
 */
public class SongViewWithArt extends SqueezerSongView {
    @SuppressWarnings("unused")
    private static final String TAG = "SqueezerSongView";

    public SongViewWithArt(SqueezerItemListActivity activity) {
        super(activity);
    ...
    /**
     * Binds the label to {@link ViewHolder#text1}. Sets {@link ViewHolder#icon} to the
     * generic pending icon, and clears {@link ViewHolder#text2}.
     *
