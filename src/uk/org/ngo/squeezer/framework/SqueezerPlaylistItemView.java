...
/**
 * Represents the view hierarchy for a single {@link SqueezerPlaylistItem} subclass.
 * with a configurable on select action.
 * 
 * @param <T>
 */
public abstract class SqueezerPlaylistItemView<T extends SqueezerPlaylistItem> extends
        SqueezerBaseItemView<T> implements OnSharedPreferenceChangeListener {
    protected SharedPreferences preferences;
    protected PlayableItemAction onSelectAction;

    public SqueezerPlaylistItemView(SqueezerItemListActivity activity) {
		super(activity);
