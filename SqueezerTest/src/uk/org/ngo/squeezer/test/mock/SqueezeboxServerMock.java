 ...
 * <p>Each instance will wait for an incoming connection, accept it, read 
 * commands from the inputstream, and reply to the outputstream, until the 
 * connection is broken or the exit command is received, at which point the
 * connection is terminated.
 * <p>To make a new connection a new instance must be started.
 * 
