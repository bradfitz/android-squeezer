 ...
 * <p>It doesn't really test any Squeezer functionally, but it is handy when
 * developing or debugging the mock server.
 * 
...
public class SqueezeboxServerMockTest extends TestCase {
    ...
    public void testDefaults() {
        ...
        try {
            ...
            BufferedReader in = new BufferedReader(new InputStreamReader(socket.getInputStream()), 128);
    ...
    public void testSettings() {
        SqueezeboxServerMock.starter().canRandomplay(false).albumsSortOrder(AlbumsSortOrder.artflow).start();
