...
public class UtilTest extends TestCase {
    ...
    public void testAtomicReferenceUpdated() {
        ...
        AtomicReference<SqueezerItem> atomicItem = new AtomicReference<SqueezerItem>();
        SqueezerAlbum album = new SqueezerAlbum("1", "album");
        SqueezerSong song = new SqueezerSong(new HashMap<String, String>());
        song.setId("1");
    ...
    public void testEncoding() {
        ...
        assertEquals("test:æøåÆØÅ'éüõÛ-_/ ;.test", Util.decode("test%3A%C3%A6%C3%B8%C3%A5%C3%86%C3%98%C3%85%27%C3%A9%C3%BC%C3%B5%C3%9B-_%2F%20%3B.test"));
        assertEquals("test%3A%C3%A6%C3%B8%C3%A5%C3%86%C3%98%C3%85%27%C3%A9%C3%BC%C3%B5%C3%9B-_%2F%20%3B.test", Util.encode("test:æøåÆØÅ'éüõÛ-_/ ;.test"));
        assertEquals("test:æøåÆØÅ'éüũÛ-_/ ;.test", Util.decode(Util.encode("test:æøåÆØÅ'éüũÛ-_/ ;.test")));
        ...
        assertEquals("album:100 80'er hits (disc 1)", Util.decode("album%3A100%2080'er%20hits%20(disc%201)"));        
    }
