 ...
 */
public class MultiPropertyAnimation extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        starter.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                TimePickerFragment.show(getSupportFragmentManager(), DateFormat.is24HourFormat(MultiPropertyAnimation.this));
            }
        });
    }
