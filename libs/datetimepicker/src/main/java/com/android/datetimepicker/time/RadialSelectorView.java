...
public class RadialSelectorView extends View {
    ...
    public List<ObjectAnimator> getDisappearAnimator() {
        ...
        ObjectAnimator radiusDisappearAnimator = ObjectAnimator.ofPropertyValuesHolder(
                this, radiusDisappear).setDuration(duration);
        radiusDisappearAnimator.addUpdateListener(mInvalidateUpdateListener);

        kf0 = Keyframe.ofFloat(0f, 1f);
        kf1 = Keyframe.ofFloat(1f, 0f);
        PropertyValuesHolder fadeOut = PropertyValuesHolder.ofKeyframe("alpha", kf0, kf1);

        Object target = AnimatorProxy.NEEDS_PROXY ? AnimatorProxy.wrap(this) : this;
        ObjectAnimator fadeOutAnimator = ObjectAnimator.ofPropertyValuesHolder(
                target, fadeOut).setDuration(duration);
        fadeOutAnimator.addUpdateListener(mInvalidateUpdateListener);

        return Arrays.asList(radiusDisappearAnimator, fadeOutAnimator);
    }
    ...
    public List<ObjectAnimator> getReappearAnimator() {
        ...
        ObjectAnimator radiusReappearAnimator = ObjectAnimator.ofPropertyValuesHolder(
                this, radiusReappear).setDuration(totalDuration);
        radiusReappearAnimator.addUpdateListener(mInvalidateUpdateListener);
        ...
        Object target = AnimatorProxy.NEEDS_PROXY ? AnimatorProxy.wrap(this) : this;
        ObjectAnimator fadeInAnimator = ObjectAnimator.ofPropertyValuesHolder(
                target, fadeIn).setDuration(totalDuration);
        fadeInAnimator.addUpdateListener(mInvalidateUpdateListener);

        return Arrays.asList(radiusReappearAnimator, fadeInAnimator);
    }
