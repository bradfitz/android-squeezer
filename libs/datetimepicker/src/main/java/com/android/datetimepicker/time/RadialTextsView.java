...
public class RadialTextsView extends View {
    ...
    ObjectAnimator mRadiusDisappearAnimator;
    ObjectAnimator mFadeOutAnimator;
    ObjectAnimator mRadiusReappearAnimator;
    ...
    private void renderAnimations() {
        ...
        mRadiusDisappearAnimator = ObjectAnimator.ofPropertyValuesHolder(
                this, radiusDisappear).setDuration(duration);
        mRadiusDisappearAnimator.addUpdateListener(mInvalidateUpdateListener);

        kf0 = Keyframe.ofFloat(0f, 1f);
        kf1 = Keyframe.ofFloat(1f, 0f);
        PropertyValuesHolder fadeOut = PropertyValuesHolder.ofKeyframe("alpha", kf0, kf1);
        mFadeOutAnimator = ObjectAnimator.ofPropertyValuesHolder(
                target, fadeOut).setDuration(duration);
        mFadeOutAnimator.addUpdateListener(mInvalidateUpdateListener);
        ...
        mRadiusReappearAnimator = ObjectAnimator.ofPropertyValuesHolder(
                this, radiusReappear).setDuration(totalDuration);
        mRadiusReappearAnimator.addUpdateListener(mInvalidateUpdateListener);
